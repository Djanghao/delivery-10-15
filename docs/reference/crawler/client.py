...
class PublicAnnouncementClient:
    """Typed wrapper for the Zhejiang investment approval public announcement APIs."""
    ...
    def close(self) -> None:  # kept for compatibility with earlier requests-based version
        return None
